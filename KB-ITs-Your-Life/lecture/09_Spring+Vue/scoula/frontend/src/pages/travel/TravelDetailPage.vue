...
const load = async () => {
  ...
  // g: global search(전역 검색), m: multiline search(다중 행 검색)
...
<template>
  <travel-header v-if="travel.images" :travel="travel" />

  <div class="content" v-html="travel.description"></div>

  <travel-images v-if="travel.images" :images="travel.images"></travel-images>
