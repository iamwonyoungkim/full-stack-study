...
@Controller
@RequestMapping("/sample") // RequestMapping은 method에 제한을 두지 않음
@Log4j2
public class SampleController {
    ...
    @GetMapping("/ex01")
    public String ex01(SampleDTO dto) { // DI 요청. 파라미터에 name과 age를 넣으면 setName, setAge가 알아서 동작한다.
        log.info("" + dto);
...
//    }
    ...
    @GetMapping("/ex04")
    // @ModelAttribute("파라미터명")을 사용하면 기본 자료형 쿼리 파라미터를 뷰로 전달할 수 있음
